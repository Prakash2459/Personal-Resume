  ...
  return (
    <div className="max-w-none">
      ...
      <nav className="mb-8 grid gap-4 sm:grid-cols-3" role="navigation" aria-label="Contact Information">
        <GalaxyCard className="fade-in-up p-4 text-sm text-center">
          <div style={{animationDelay: '0ms'}}>
            <a href="mailto:prakashprakash2459@gmail.com" aria-label="Send email to Jambula Venkata Jaya Prakash Reddy">📧 Email</a>
          </div>
        </GalaxyCard>
        <GalaxyCard className="fade-in-up p-4 text-sm text-center">
          <div style={{animationDelay: '80ms'}}>
            <a href="https://www.jayaprakash.space" target="_blank" rel="noreferrer noopener" aria-label="Visit personal website">🌐 Website</a>
          </div>
        </GalaxyCard>
        <GalaxyCard className="fade-in-up p-4 text-sm text-center">
          <div style={{animationDelay: '160ms'}}>
            <a href="https://github.com/Prakash2459" target="_blank" rel="noreferrer noopener" aria-label="View GitHub profile">💻 GitHub</a>
          </div>
        </GalaxyCard>
      </nav>

      {/* Professional Summary */}
      <GalaxyCard className="mb-8 fade-in-up p-6">
        <div id="summary" style={{animationDelay: '120ms'}}>
      ...
      <section className="mb-8 grid gap-6 md:grid-cols-2">
        <GalaxyCard className="p-6 fade-in-up">
          <div id="skills" style={{animationDelay: '180ms'}}>
        ...
        <GalaxyCard className="p-6 fade-in-up">
          <div id="education" style={{animationDelay: '220ms'}}>
      ...
      <GalaxyCard className="mb-8 fade-in-up p-6">
        <div id="projects" style={{animationDelay: '260ms'}}>
      ...
      <GalaxyCard className="mb-8 fade-in-up p-6">
        <div id="achievements" style={{animationDelay: '300ms'}}>
      ...
      <GalaxyCard className="mb-8 fade-in-up p-6">
        <div id="experience" style={{animationDelay: '340ms'}}>
      ...
      <GalaxyCard className="mb-8 fade-in-up p-6">
        <div id="portfolio" style={{animationDelay: '380ms'}}>
      ...
      {/* Call to Action */}
      <GalaxyCard className="mb-2 fade-in-up p-6">
        <div id="contact" style={{animationDelay: '420ms'}}>
